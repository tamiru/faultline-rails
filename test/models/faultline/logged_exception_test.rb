...
class Faultline::LoggedExceptionTest < ActiveSupport::TestCase
  setup do
  ...
  test "create_from_exception stores exception details" do
    ...
    logged = Faultline::LoggedException.create_from_exception(controller, error, {})
  ...
  test "create_from_exception includes extra data" do
    ...
    logged = Faultline::LoggedException.create_from_exception(controller, error, data)
  ...
  test "create_from_exception with nil data sets message" do
    ...
    logged = Faultline::LoggedException.create_from_exception(controller, error, nil)
  ...
  test "scope sorted returns most recent first" do
    ...
    results = Faultline::LoggedException.sorted
  ...
  test "scope message_like filters by message content" do
    ...
    results = Faultline::LoggedException.message_like("NullPointer")
  ...
  test "scope message_like is safe against SQL injection" do
    ...
    results = Faultline::LoggedException.message_like("%")
  ...
  test "scope days_old filters by recency" do
    ...
    results = Faultline::LoggedException.days_old(7)
  ...
  test "scope by_exception_class filters correctly" do
    ...
    results = Faultline::LoggedException.by_exception_class("RuntimeError")
    assert_equal 1, results.count
  ...
  test "scope by_controller filters correctly" do
    ...
    results = Faultline::LoggedException.by_controller("users")
    assert_equal 1, results.count
  end
  ...
  test "scope by_action filters correctly" do
    ...
    results = Faultline::LoggedException.by_action("show")
    assert_equal 1, results.count
  end
  ...
  test "class_names returns distinct exception classes" do
    ...
    names = Faultline::LoggedException.class_names
  ...
  test "controller_actions returns distinct controller/action pairs" do
    ...
    actions = Faultline::LoggedException.controller_actions
  ...
  test "host_name returns hostname" do
    assert_kind_of String, Faultline::LoggedException.host_name
    refute_empty Faultline::LoggedException.host_name
  end
  ...
  def create_exception(attrs = {})
    ...
    Faultline::LoggedException.create!(defaults.merge(attrs))
  end
